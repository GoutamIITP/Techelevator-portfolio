<div class="container my-5">
  <div class="p-4 shadow-lg rounded bg-white">
    ...
    <p>At TechElevatr Digital Solutions, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.</p>
    ...
    <h5 class="mt-3">Automatically Collected Information</h5>
    ...
    <ul>
      <li><strong>Service Delivery:</strong> To provide, maintain, and improve our IT services</li>
      <li><strong>Communication:</strong> To respond to inquiries, send project updates, and provide support</li>
      <li><strong>Marketing:</strong> To send newsletters, promotional offers, and service updates (with your consent)</li>
    ...
    <ul>
      <li><strong>Service Providers:</strong> With trusted third-party vendors who assist in operating our website and services (e.g., payment processors, hosting providers)</li>
    ...
    <p>We retain your personal information only for as long as necessary to fulfill the purposes outlined in this policy, unless a longer retention period is required by law. Project-related data is typically retained for 7 years for legal and accounting purposes.</p>

    <h4 class="mt-4">10. International Data Transfers</h4>
    ...
    <h4 class="mt-4">11. Changes to This Privacy Policy</h4>
    ...
    <div class="alert alert-info mt-4">
      ...
      <strong>Your Privacy Matters:</strong> We are committed to transparency and protecting your personal information. If you have any concerns, please don't hesitate to reach out to us.
    </div>
  </div>
</div>